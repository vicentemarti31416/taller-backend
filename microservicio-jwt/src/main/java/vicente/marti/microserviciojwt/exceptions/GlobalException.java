package vicente.marti.microserviciojwt.exceptions;
...
import vicente.marti.microserviciojwt.dto.MessageDto;
import vicente.marti.microserviciojwt.utils.Operations;
...
public class GlobalException {
    ...
    public ResponseEntity<MessageDto> badCredentialsException(BadCredentialsException e) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new MessageDto(HttpStatus.NOT_FOUND, "bad credentials"));
    }

    @ExceptionHandler(AccessDeniedException.class)
    public ResponseEntity<MessageDto> accessDeniedException(AccessDeniedException accessDeniedException) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(new MessageDto(HttpStatus.FORBIDDEN, "cannot access this resource"));
    }
